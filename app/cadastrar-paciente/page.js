...
/**
 * PÁGINA DE MENU - PACIENTES
 * Opções: Gerenciar Pacientes ou Adicionar Novo Paciente
 */
export default function CadastrarPacientePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Header titulo="Pacientes" mostrarVoltar voltarPara="/busca" />
      ...
      <main className="container mx-auto px-4 py-6 max-w-2xl">
        ...
        <div className="space-y-4">
          ...
          {/* Gerenciar Pacientes */}
          <button
            onClick={() => router.push('/gerenciar-pacientes')}
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-gray-600">
                    Ver, editar e gerenciar pacientes cadastrados
                  </p>
                </div>
              </div>
